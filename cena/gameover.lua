	...
	local function CenaVMenu()
		audio.stop( 1 )
		composer.removeScene ("cena.gameO") 
	...
	function scene:create( event )
     ...
     fimdejogo = audio.loadSound( "music/fimdejogo.mp3" )
     ...
     local gameO = display.newImage(backGroup,"Imagens/gameO.png")
     gameO.x = display.contentCenterX
     gameO.y = display.contentCenterY
