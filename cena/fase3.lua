...
-- add o cristal-----------------------------------------------------------------------
	...
	-----Inimigos-----------------------------------------------------------------------------------------------------
		local ini1 =display.newImageRect(mainGroup,"Imagens/im3.png",25,25)
		ini1.x=93
		ini1.y=50
		ini1.id="ini1"

		local ini2 =display.newImageRect(mainGroup,"Imagens/im3.png",25,25)
		ini2.x=190
		ini2.y=20
		ini2.id="ini2"

		local ini3 =display.newImageRect(mainGroup,"Imagens/im3.png",25,25)
		ini3.x=200
		ini3.y=400
		ini3.id="ini3"

		local ini4 =display.newImageRect(mainGroup,"Imagens/im3.png",25,25)
		ini4.x=300
		ini4.y=120
		ini4.id="ini4"
	...
	function moveInimigo1()
		transition.to(ini1,{time=33000,x=math.random(25,295),y=
		math.random( 45, 447 ),onComplete=moveInimigo1})
	end
	moveInimigo1()
	function moveInimigo2()
		transition.to(ini2,{time=33000,x=math.random(25,295),y=
		math.random( 45, 447 ),onComplete=moveInimigo2})
	end
	moveInimigo2()
	function moveInimigo3()
		transition.to(ini3,{time=33000,x=math.random(25,295),y=
		math.random( 45, 447 ),onComplete=moveInimigo3})
	end
	moveInimigo3()
	function moveInimigo4()
		transition.to(ini4,{time=33000,x=math.random(25,295),y=
		math.random( 45, 447 ),onComplete=moveInimigo4})
	end
	moveInimigo4()

	--[[function moveInimigo5()
		transition.to(ini5,{time=20000,x=math.random(25,295),y=
		math.random( 45, 447 ),onComplete=moveInimigo5})
	end
	moveInimigo5()

	function moveInimigo6()
		transition.to(ini6,{time=20000,x=math.random(25,295),y=
		math.random(45, 447 ),onComplete=moveInimigo6})
	end
	moveInimigo6()

	function moveInimigo7()
		transition.to(ini7,{time=20000,x=math.random(25,295),y=
